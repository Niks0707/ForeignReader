...
/**
 * Created by Niks on 23.10.2016.
 */

public class OpenFileDialogAnother extends AlertDialog.Builder {
    ...
    public OpenFileDialogAnother(Context context) {
        super(context);
    ...
    public OpenFileDialogAnother setFilter(final String filter) {
    ...
    public OpenFileDialogAnother setFiltersEndWith(final String[] filtersEndWith) {
        filenameFilter = new FilenameFilter() {
            ...
            public boolean accept(File file, String fileName) {
                ...
                if (tempFile.isFile()) {
                    ...
                    for (String filter : filtersEndWith) {
                        isAccept = tempFile.getName().endsWith(filter);
                        if (isAccept) return isAccept;
                    }
                    return false;
                }
                return true;
    ...
    public OpenFileDialogAnother setOpenDialogListener(OpenDialogListener listener) {
        this.listener = listener;
        return this;
    }

    public OpenFileDialogAnother setFolderIcon(Drawable drawable) {
        this.folderIcon = drawable;
        return this;
    }

    public OpenFileDialogAnother setFileIcon(Drawable drawable) {
        this.fileIcon = drawable;
        return this;
    }

    public OpenFileDialogAnother setAccessDeniedMessage(String message) {
